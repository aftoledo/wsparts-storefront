...
- `Configs/` — explain what lives here and when agents should edit it.
- `Emails/` — explain what lives here and when agents should edit it.
- `fbits.storefront.exe/` — explain what lives here and when agents should edit it.
